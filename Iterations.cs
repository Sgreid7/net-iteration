...
namespace DotnetIteration
{
   ...
   */
    ...
    {
      return data.Where(item => item % 2 == 0);
    }
    /*
    ...
    {
      return data.Where(item => item.Contains("needle")).FirstOrDefault();
    }
    ...
    {
      return data.Any(item => item.Length == 4);
    }
  }
}